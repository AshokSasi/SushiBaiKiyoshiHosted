...
class MenuItemsController extends Controller
{
    ...
    public function update($id, Request $request)
    {
        ...
        MenuItems::where('id', $id)
            ->update(['menuItemName' => $request->input('itemname'), 'menuItemDescription' => $request->input('body'), 'menuItemPrice' => $request->input('price')]);
        // ->update(['menuItemDesciption' => $request->input('body')]),
        // ->update(['menuItemPrice' => $request->input('price')]);
