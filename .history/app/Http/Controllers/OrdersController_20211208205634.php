...
class OrdersController extends Controller
{
    ...
    public function index()
    {
        ...
        //dd($menuItems);
        return view('orders.index', compact('statusFilterFlag', 'menuFilterFlag'), compact('orders', 'menuList', 'orderMenuList'));
    }
    ...
    public function filter(request $request)
    {
        ...
        //dd($menuItems);
        return view('orders.index', compact('orders', 'menuList', 'orderMenuList'), compact('statusFilterFlag', 'menuFilterFlag'));
    }
