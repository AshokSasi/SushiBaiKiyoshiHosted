  ...
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption text-start">
            <div>
              <h1 class="contOpa rounded">Welcome to Sushi Bai Kiyoshi</h1>
                  <p>Home of the most mouthwatering sushi in Downtown Toronto</p>
      ...
      <div class="carousel-item">
        <img class="d-block w-100" src="/img/interior.jpg" alt="Second slide">
      ...
      <div class="carousel-item">
         <img class="d-block w-100" height="100%" src="/img/salmon-sushi.jpg" alt="First slide">
