    ...
    <div class="col-md-5 col-lg-4 order-md-last">
      ...
      <ul class="list-group mb-3">
        <li class="list-group-item d-flex justify-content-between lh-sm">
          ...
          <span class="text-muted">${{ number_format((float)$menuItems['price'],2) }}</span>
          <span><button class="btn btn-danger btn-sm remove-from-cart" data-id="{{ $id }}"><i class="fas fa-trash"></i></button></span>
        </li>
     @endforeach
     @endif
