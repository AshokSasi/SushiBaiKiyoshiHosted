...
Title:      menuitems/create.blade.php
Created by: Ashok Sasitharan, Andre Agrippa, Jacky Yuan
Details:    This page generates add menu item page content of the website which is used to add a new 
            item into the menu. 
             ...
             <label for="months">Add Tags:</label>
              <!--Do a loop querying through every tag -->
                <select name="tags" id="cars">
                    ...
                    <option value={{$stock->stockDescription}}>{{$stock->stockDescription}}</option>
                    @endforeach
                </select>
