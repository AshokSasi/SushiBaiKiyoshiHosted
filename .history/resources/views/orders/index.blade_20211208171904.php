        ...
        <select name="months" id="cars">
          ...
          <label for="statusFilter">Filter by Status</label>
              <select  name="statusFilter" id="statusFilter">
                        <option value="All" @if($order->orderStatus === "In Progress" ){{ $var="selected"}}>All</option>
                        <option value="In Progress" @if($order->orderStatus === "In Progress" ){{ $var="selected"}}>In Progress</option>
                        <option value="Completed" @if($order->orderStatus === "In Progress" ){{ $var="selected"}}>Completed</option>
	                      <option value="Cancelled" @if($order->orderStatus === "In Progress" ){{ $var="selected"}}>Cancelled</option>
                      </select>
            </select>
