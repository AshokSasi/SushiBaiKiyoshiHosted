        ...
        <select name="months" id="cars">
          ...
          <label for="statusFilter">Filter by Status</label>
              <select  name="statusFilter" id="statusFilter">
                        <option value="All" @if($statusFilterFlag->first() == "ALL" ){{ $var="selected"}}@endif>All</option>
                        <option value="In Progress" @if($statusFilterFlag->first() == "In Progress" ){{ $var="selected"}}@endif>In Progress</option>
                        <option value="Completed" @if($statusFilterFlag->first() == "Completed" ){{ $var="selected"}}@endif>Completed</option>
	                      <option value="Cancelled" @if($statusFilterFlag->first() == "Cancelled" ){{ $var="selected"}}@endif>Cancelled</option>
            </select>
