        ...
        <table class="table table-hover table-striped table-dark">
            ...
            <tbody>
              @foreach($orders as $order)
                ...
                <option value="Completed" @if($user->userPosition === "Completed") {{$var="selected"}}  @endif>Completed</option>
	            <option value="Cancelled" @if($user->userPosition === "Cancelled") {{$var="selected"}}  @endif>Cancelled</option>
            </select>
