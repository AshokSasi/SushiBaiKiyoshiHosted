        ...
        <select name="months" id="cars">
          ...
          <label for="statusFilter">Filter by Status</label>
              <select  name="statusFilter" id="statusFilter">
                        <option value="All"@if($StatusFilter === "In Progress" ){{ $var="selected"}}>All</option>
                        <option value="In Progress" @if($StatusFilter === "In Progress" ){{ $var="selected"}} @endif>In Progress</option>
                        <option value="Completed" @if($StatusFilter === "Completed") {{$var="selected"}}  @endif>Completed</option>
	                      <option value="Cancelled" @if($StatusFilter === "Cancelled") {{$var="selected"}}  @endif>Cancelled</option>
                      </select>
            </select>
