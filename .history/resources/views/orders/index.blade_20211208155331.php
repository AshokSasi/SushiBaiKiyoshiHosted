        ...
        <select name="months" id="cars">
          ...
          <label for="statusFilter">Filter by Status</label>
              <select  name="statusFilter" id="statusFilter">
                        ...
                        <option value="In Progress" @if($orders->orderStatus === "In Progress" ){{ $var="selected"}} @endif>In Progress</option>
                        <option value="Completed" @if($orders->orderStatus === "Completed") {{$var="selected"}}  @endif>Completed</option>
	                      <option value="Cancelled" @if($orders->orderStatus === "Cancelled") {{$var="selected"}}  @endif>Cancelled</option>
                      </select>
            </select>
