        ...
        <select name="months" id="cars">
          ...
          <label for="statusFilter">Filter by Status</label>
              <select  name="statusFilter" id="statusFilter">
                        <option value="All" @if($order->orderStatus === "ALL" ){{ $var="selected"}}>All</option>
                        <option value="In Progress" @if($order->orderStatus === "In Progress" ){{ $var="selected"}}>In Progress</option>
                        <option value="Completed" @if($order->orderStatus === "Completed" ){{ $var="selected"}}>Completed</option>
	                      <option value="Cancelled" @if($order->orderStatus === "Cancelled" ){{ $var="selected"}}>Cancelled</option>
                      </select>
            </select>
