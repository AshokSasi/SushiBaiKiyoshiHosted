        ...
        <select name="months" id="cars">
          ...
          <label for="statusFilter">Filter by Status</label>
              <select  name="statusFilter" id="statusFilter">
                        <option value="All" @if($statusFilterFLag == "ALL" ){{ $var="selected"}}>All</option>
                        <option value="In Progress" @if($statusFilterFLag == "In Progress" ){{ $var="selected"}}>In Progress</option>
                        <option value="Completed" @if($statusFilterFLag == "Completed" ){{ $var="selected"}}>Completed</option>
	                      <option value="Cancelled" @if($statusFilterFLag == "Cancelled" ){{ $var="selected"}}>Cancelled</option>
                      </select>
            </select>
