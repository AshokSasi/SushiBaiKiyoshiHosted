...
Title:      orders/show.blade.php
Created by: Ashok Sasitharan, Andre Agrippa, Jacky Yuan
Details:    This page generates the page content for a specific order of the website which displays
            all the details of the specific order selected. 
