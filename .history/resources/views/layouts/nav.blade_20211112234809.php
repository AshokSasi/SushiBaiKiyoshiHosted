  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::is('Menu') ? 'active' : null }}" href="/menu/index">Menu</a>
        </li>
        ...
        @if(Auth::check())
        <li class="nav-item">
          <a class="nav-link " href="/user/index">{{ Auth::user()->userFirstName Request::is('Auth::user()->userFirstName') ? 'active' : null}}</a>
        </li>
