    ...
    <div class="col-md-8">
        ...
        <form method="POST" action="/admin" >
            ...
            <select class="form-control"name="role" id="role">
                ...
                <option value="a" @if($user->userPosition == "a" ) @php(echo 'selected';) @endif>Admin</option>
                <option value="e">Employee</option>
	            <option value="c" @if($user->userPosition == "c") @php(echo 'selected';) @endif>Customer</option>
            </select>
              </div>
