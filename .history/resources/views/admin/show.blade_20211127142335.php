            ...
            <div class="mt-2 buttoninline">
                ...
                <form  method="GET" action="/admin/delete/{{ $user->id}}">
                   {{csrf_field()}}
                    ...
                    <a href="/admin/edit/{{ $user->id}}"><button type="button" class="btn btn-primary buttoninline">Edit</button></a>
                    <button type="submit"  class="btn btn-danger buttoninline">Delete</button>
