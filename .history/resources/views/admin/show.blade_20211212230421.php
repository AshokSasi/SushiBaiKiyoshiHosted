...
Title:      admin/show.blade.php
Created by: Ashok Sasitharan, Andre Agrippa, Jacky Yuan
Details:    This page generates the show user page content of the website that displays the
            specific details of a user. 
    ...
    <div class="col-md-8">
        ...
        <form action="/admin" >
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="email" value="{{$user->userEmail}}" readonly >
            </div>
